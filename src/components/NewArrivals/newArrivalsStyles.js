...
export const NewProductsMainContainer = styled(Grid)(() => ({
  width: "100%",
  height: "auto",
  display: "flex",
...
export const TitleNewProducts = styled(Box)(() => ({
  color: "#000",
  textAlign: "center",
  fontSize: "48px",
  fontWeight: "700",
...
export const NameNewProducts = styled(Typography)(() => ({
  color: "#000",
  fontSize: "18px",
  fontWeight: "700",
...
export const PriceNewProduct = styled(Typography)(() => ({
  color: "#000",
  fontSize: "20px",
  fontWeight: 700,
  marginRight: "10px",
